...
private:
    ...
    std::string stegocontainerFileName = "ImgStegocontainer.bmp";
    std::string containerNoiseFileName = "ImgNoiseContainer.bmp";
    std::string stegocontainerNoiseFileName = "ImgNoiseStegocontainer.bmp";
